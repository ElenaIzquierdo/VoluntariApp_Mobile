const INITIAL_STATE ={
    ...
    estat_actual: {description: 'La persona prehistòrica ja ha tornat a la seva era, però ha espatllat la màquina i hem ' +
            'de trobar les peces per arreglar-la i que la científica pugui tornar', finished: false},
    explicacio: [
        ...
        {id: 2, title: 'Dia 18', description: 'Petits rep una carta de la cientifica on explica que ha tonrat el personatge prehistoric' +
                ...
                'que lajudem a reconstruir la maquina.'},
        {id: 3, title: 'Dia 19', description: 'Trobem les peces per arreglar la maquina'},
