const INITIAL_STATE ={
    ...
    participants:[
        ...
        {id:3, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:4, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:5, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:6, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:7, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:8, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:9, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:10, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
        {id:11, name: 'Laura Gonzalez', image:require('../images/user3.jpg')},
